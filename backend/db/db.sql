...
('admin@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');

-- Insert default pengaturan web
INSERT INTO pengaturan_web (
    judul_web, tagline_web, caption_web, tentang_web, footer_web, 
    nama_instansi, nama_pimpinan, nik_pimpinan, alamat_instansi, 
    email_instansi, telp, whatsapp
) VALUES (
...
-- Insert sample data for mata pelajaran
INSERT INTO mata_pelajaran (kode_mapel, nama_mapel, deskripsi, kategori) VALUES
...
INSERT INTO users (email, password, role) VALUES 
('ustadz1@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pengajar'),
('ustadz2@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pengajar'),
('ustadz3@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pengajar'),
('ustadzah1@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pengajar'),
('ustadzah2@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pengajar');

INSERT INTO ustadz (user_id, nama, nik, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, telepon, email, pendidikan_terakhir, bidang_keahlian, tanggal_bergabung) VALUES
...
-- Insert sample kelas
INSERT INTO kelas (kode_kelas, nama_kelas, tingkat, wali_kelas_id, kapasitas, keterangan) VALUES
...
-- Insert sample santri users
INSERT INTO users (email, password, role) VALUES 
('santri1@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri2@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri3@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri4@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri5@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri6@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri7@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri'),
('santri8@pesantren.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'santri');

-- Insert sample santri
INSERT INTO santri (user_id, nama, nis, jenis_kelamin, asal_sekolah, tanggal_lahir, alamat, telepon, nama_wali, pekerjaan_wali, alamat_wali, telepon_wali, tanggal_masuk) VALUES
...
-- Insert penempatan santri di asrama
INSERT INTO santri_asrama (santri_id, asrama_id, nomor_kamar, tanggal_masuk) VALUES
(1, 1, 'A101', '2023-07-01'),
(2, 1, 'A102', '2023-07-01'),
(3, 3, 'B101', '2023-07-01'),
(4, 3, 'B102', '2023-07-01'),
...
-- Insert penempatan santri di kelas
INSERT INTO santri_kelas (santri_id, kelas_id, tahun_ajaran, semester, tanggal_masuk) VALUES
...
-- Insert sample jadwal pelajaran untuk Senin
...
-- Insert sample nilai
INSERT INTO nilai (santri_id, mapel_id, jenis_nilai, nilai, tahun_ajaran, semester, dibuat_oleh) VALUES
...
-- Insert sample tahfidz
INSERT INTO tahfidz (santri_id, surat, ayat_mulai, ayat_selesai, tanggal_mulai, tanggal_selesai, status, nilai_hafalan, pembimbing_id) VALUES
...
-- Insert sample PSB
INSERT INTO psb (tahun_ajaran, tanggal_buka, tanggal_tutup, kuota_putra, kuota_putri, biaya_pendaftaran, persyaratan, kontak_panitia, email_panitia) VALUES
('2024/2025', '2024-03-01', '2024-06-30', 100, 80, 250000.00, 
...
'081234567890', 'psb@pesantrenwalisongo.com');

-- Insert sample keuangan
INSERT INTO keuangan (santri_id, kode_transaksi, jenis_transaksi, kategori, jumlah, tanggal_transaksi, metode_pembayaran, keterangan, status, diproses_oleh) VALUES
